...
class BlogPostDAO:
    ...
    def get_posts(self, num_posts):
        ...
        cursor = self.posts.find().sort('date', direction = -1).limit(10)
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            last_error = self.posts.update({'permalink':permalink}, {'$push':{'comments':comment}}, upsert = False, manipulate = False, safe = True)
